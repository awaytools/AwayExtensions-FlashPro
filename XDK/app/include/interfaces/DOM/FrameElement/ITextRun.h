 ...
 *        represents a string of characters which have the common text style. 
 */
...
namespace DOM 
{
    namespace FrameElement
    {
         ...
         * @class ITextRun
         *
         * @brief Defines an interface that represents a string of characters which have the common text attributes.
         */    
        BEGIN_DECLARE_INTERFACE(ITextRun, IID_ITEXT_RUN)
                
           /**
            * @brief  This function returns index of first character within Text element where this textrun starts.
            *
            * @param  startIndex (OUT)
            *         The index of first character within Text element where this textrun starts is returned.
            *
