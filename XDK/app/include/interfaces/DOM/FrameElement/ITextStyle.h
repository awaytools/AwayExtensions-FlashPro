...
namespace DOM 
{
    namespace FrameElement
    {
       ...
       *
       * @brief This enumerates base line shift styles.
       */
      enum BaseLineShiftStyle
          { 
...
namespace DOM 
{
    ...
    {        
         ...
         * @class ITextStyle
         *
         * @brief Defines an interface that represents properties which describe characters.
         */    
        BEGIN_DECLARE_INTERFACE(ITextStyle, IID_ITEXT_STYLE)                
            ...
            /**
             * @brief  If this function returns true use pair kerning information in the 
             *         font(s) to kern the text. If false, pair kerning information in 
             *         the font(s) is ignored. Only works with Static Text, will be ignored 
             *         if used with other text types..
             *
             * @param  autoKern (OUT)
             *         Returns if kerning pair info is to be used(or) not.
             *
             * @return On success, FCM_SUCCESS is returned; otherwise an error code is returned.
             */            
           ...
           /**
             ...
             *         static text in other cases BASE_LINE_SHIFT_STYLE_NORMAL is returned.
             *
           ...
           /**
            * @brief  This function returns if characters of the text are rotated 90 degrees.
            *         This will be returned for static text with a vertical orientation in 
            ...
            *         static text in other cases NULL will be returned.
            *
