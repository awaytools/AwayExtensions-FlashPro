...
AnimateToAWDEncoder::AnimateToAWDEncoder(FCM::PIFCMCallback pCallback, AWDProject* awd_project)
{
...
AnimateToAWDEncoder::~AnimateToAWDEncoder()
{
...
AWDProject*
AnimateToAWDEncoder::get_project(){
	return this->awd_project;
}

TYPES::F64* 
AnimateToAWDEncoder::convert_matrix2x3(DOM::Utils::MATRIX2D matrix2x3)
{	
	int flipx=1;
...
TYPES::F64* 
AnimateToAWDEncoder::convert_matrix4x5_to_colortransform(DOM::Utils::COLOR_MATRIX color_mtx)
{
