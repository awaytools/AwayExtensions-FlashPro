...
namespace AwayJS
{
    ...
    AwayXFLDocumentHandler::AwayXFLDocumentHandler(AwayJS::FeatureMatrix *pFeatureMat) :
        DocumentHandler(), 
    ...
    void AwayXFLDocumentHandler::startElement(const XMLCh* const name, AttributeList& attrs)
    {
    ...
    void AwayXFLDocumentHandler::endElement(const XMLCh* const name)
    {
        char elementName[1024];
        XMLString::transcode(name, elementName, 1024 - 1);
        std::string elemName(elementName);
