                                    ...
                                    , XSerializeEngine&                      serEng)
{
    if (serEng.needToStoreObject(objToStore))
    {
        ...
        for (XMLSize_t i=0; i < itemNumber; i++)
        {
            ...
            unsigned int iden  = serEng.getStringPool()->getId(strKey);
            serEng<<iden;
        ...
        while (e.hasMoreElements())
        {
            ...
            unsigned int iden  = serEng.getStringPool()->getId(key);
                                   ...
                                   , XSerializeEngine&                 serEng)
{
    if (serEng.needToLoadObject((void**)objToLoad))
    {
        ...
        for (XMLSize_t itemIndex = 0; itemIndex < itemNumber; itemIndex++)
        {
            ...
            XMLCh* key = (XMLCh*) serEng.getStringPool()->getValueForId(iden);
                                   ...
                                   , XSerializeEngine&                   serEng)
{
    if (serEng.needToLoadObject((void**)objToLoad))
    {
        ...
        for (XMLSize_t itemIndex = 0; itemIndex < itemNumber; itemIndex++)
        {
             ...
             *  to do:
             ***/
            unsigned int iden = serEng.getStringPool()->getId(typeKey);
            XMLCh* refKey = (XMLCh*) serEng.getStringPool()->getValueForId(iden);
