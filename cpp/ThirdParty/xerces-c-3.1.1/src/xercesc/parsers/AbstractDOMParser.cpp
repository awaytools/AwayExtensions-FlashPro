...
)
{
    ...
    if (fDocumentType->isIntSubsetReading())
    {
        ...
        const XMLCh* iden = entity->getPublicId();
        if (iden != 0) {
            fInternalSubset.append(chSpace);
            fInternalSubset.append(XMLUni::fgPubIDString);
            fInternalSubset.append(chSpace);
            fInternalSubset.append(chDoubleQuote);
            fInternalSubset.append(iden);
            fInternalSubset.append(chDoubleQuote);
        }
        iden = entity->getSystemId();
        if (iden != 0) {
            fInternalSubset.append(chSpace);
...
)
{
    ...
    if (fDocumentType->isIntSubsetReading())
    {
        ...
        const XMLCh* iden = notation->getPublicId();
        if (iden != 0) {
            fInternalSubset.append(chSpace);
            fInternalSubset.append(XMLUni::fgPubIDString);
            fInternalSubset.append(chSpace);
